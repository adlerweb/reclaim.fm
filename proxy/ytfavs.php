...
$count = 10;
$user = $google_user;
$apiurl = "https://gdata.youtube.com/feeds/api/users/".$user."/favorites?alt=json&prettyprint=true&orderby=published&racy=include&v=2&client=ytapi-youtube-profile";
...
if ($response['version']=="1.0") {
	...
	$feed->setTitle($user.'s Youtube Favourites'); // set your title
	$feed->setLink('http://stream.wirres.net/proxy/ytfavs.php'); // set the url to the feed page you're generating
